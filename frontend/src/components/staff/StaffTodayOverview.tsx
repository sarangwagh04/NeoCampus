...
interface StaffTodayOverviewProps {
  ...
  schedule: TodayClass[] | null;
  isLoading: boolean;
  onMarkAttendance: (classItem: TodayClass) => void;
}
const statusConfig = {
  marked: {
    label: "Marked",
              ...
              return <div key={classItem.id} className={cn("p-4 rounded-lg border bg-card hover:bg-muted/50 transition-colors animate-slide-up", classItem.attendanceStatus === "pending" && "border-warning/30 bg-warning/5")} style={{
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {classItem.attendanceStatus === "pending" && <Button size="sm" onClick={() => onMarkAttendance(classItem)} className="bg-primary hover:bg-primary/90">
