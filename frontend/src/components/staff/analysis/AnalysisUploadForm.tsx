        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={metadata.academicYear} onValueChange={(v) => onUpdateMetadata("academicYear", v)}>
                <SelectTrigger className="bg-background">
            ...
            <div className="space-y-2">
              ...
              <Select value={metadata.examName} onValueChange={(v) => onUpdateMetadata("examName", v)}>
                <SelectTrigger className="bg-background">
            ...
            <div className="space-y-2">
              ...
              <Select value={metadata.department} onValueChange={(v) => onUpdateMetadata("department", v)}>
                <SelectTrigger className="bg-background">
