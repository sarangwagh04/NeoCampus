...
export function AnalysisMethodSelector({ onSelect }: AnalysisMethodSelectorProps) {
  ...
  const handleTryoutFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Send PDF to backend AI tryout endpoint
      // ================================
      ...
      // ================================
      // 🔁 EXISTING LOGIC PRESERVED
      // Handle Excel file returned from backend
      // ================================
          ...
          <CardContent className="space-y-4 relative">
            ...
            <div className="pt-2 border-t border-violet-200/50 dark:border-violet-800/50">
              ...
              <p className="text-xs text-muted-foreground mb-3">
                ...
                Pricing: <span className="font-medium bg-gradient-to-r from-violet-600 to-purple-600 dark:from-violet-400 dark:to-purple-400 bg-clip-text text-transparent">

                  ₹99 / Analysis

                </span> or Institution Plan
              ...
              <div className="flex gap-2">
                ...
                {/* ================================
                   🔁 CHANGED: Enabled AI method button
                   Previously: "Coming Soon" disabled button
                   Now: Allows selecting AI analysis
                ================================ */}

                <Button
                  className="flex-1 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 hover:scale-[1.01] transition-all duration-300"
                  onClick={() => onSelect("ai")}
                >
