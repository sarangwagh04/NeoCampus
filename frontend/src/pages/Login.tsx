            ...
            <CardContent className="relative">
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => { setUsername("student"); setPassword("Pass@123"); }}
                  ...
                  <button
                    type="button"
                    onClick={() => { setUsername("staff"); setPassword("Pass@123"); }}
                  ...
                  <button
                    type="button"
                    onClick={() => { setUsername("HOD"); setPassword("Pass@123"); }}
              ...
              >
                <p className="text-xs text-muted-foreground text-center leading-relaxed">
                  <span className="font-semibold text-foreground/80">Admin?</span> Use admin portal for administrative access.
                </p>
              </motion.div>
            </CardContent>
          </Card>
