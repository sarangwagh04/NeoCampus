            ...
            <CardContent className="relative">
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => { setUsername("student@neocampus.com"); setPassword("Pass@123"); }}
                  ...
                  <button
                    type="button"
                    onClick={() => { setUsername("staff@neocampus.com"); setPassword("Pass@123"); }}
                  ...
                  <button
                    type="button"
                    onClick={() => { setUsername("hod@neocampus.com"); setPassword("Pass@123"); }}
